...
const Footer = () => {
  return (
    <>
      <footer className="mobile:flex mobile:flex-row-reverse flex-col justify-center gap-36 px-4  py-10 ">
        ...
        <ul className="flex flex-row-reverse flex-wrap justify-between gap-5 mt-3 text-black w-auto mx-5 my-4">
          <li>خانه</li>
          <li>دوره</li>
          <li>بلاگ ها</li>
          <li>اساتید</li>

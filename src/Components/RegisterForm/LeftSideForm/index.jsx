...
const index = () => {
  return (
    <>
      <div className="hidden mobile:block w-[700px] rounded-3xl bg-gray-100 dark:bg-gray-300 my-4">
        ...
        <div className=" flex flex-col gap-3 items-end mr-4 my-24">
          <h2 className="font-bold text-2xl text-right text-black dark:text-blue-900">
            شروع یک ماجراجویی
          </h2>
          <p className="text-sm text-right text-black dark:text-blue-900">

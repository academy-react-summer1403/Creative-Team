        ...
        <div className="">
          <div className="flex flex-col w-[1440px]  justify-items-center text-center">
            <div className=" flex flex-row justify-center  pr-10">
              <div className="right h-[424px] w-[642px] order-1  ">
                <img
              ...
              <div className="left order-2 ">
                ...
                <div className="5 flex gap-1 cursor-pointer">
                  <div className="border-blue-500 border rounded-3xl w-60	h-12	flex justify-center gap-2 m-2  pt-2">
                    <img
                  ...
                  <div className="w-[270px] h-[56px] mt-1">
            ...
            <div className="  text-base m-10 w-[1360px] h-[92px]  flex flex-col gap-10 ">
              <p className="text-pretty text-right justify-items-center">
          ...
          <div className="flex flex-col gap-1 mt-96">
            <div className="mb-10 mr-8">
              <h2 className="f4 f40">نظرات دانشجو ها و اساتید</h2>
            </div>
          ...
          <div className="bartarBlog w-[1440px] mt-70">
            {/* <TopBlogs /> */}
